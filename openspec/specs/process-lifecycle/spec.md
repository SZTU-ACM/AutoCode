...
Specify the guarantees AutoCode must uphold for creating, cancelling, and reclaiming generator/compiler subprocesses (and their child trees) so that no residual processes survive under normal or cancelled execution paths.
